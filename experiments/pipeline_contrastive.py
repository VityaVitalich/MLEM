...
from src.trainers.trainer_contrastive import (AccuracyTrainerContrastive,
...
class ContrastivePipeline(Pipeline):
    def _train_eval(self, run_name, conf, model_conf):
        ...
        train_supervised_loader, valid_supervised_loader, test_supervised_loader = create_data_loaders(conf, pinch_test=True)

...
from configs.model_configs.mTAN.age import model_configs
from src.data_load.dataloader import create_data_loaders, create_test_loader
from src.trainers.trainer_Simple import AccuracySimpleTrainerSupervised
...
def run_experiment(run_name, device, total_epochs, conf, model_conf, resume, log_dir):
    ...
    trainer = AccuracySimpleTrainerSupervised(
        model=net,
        optimizer=opt,

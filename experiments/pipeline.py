...
def run_experiment(run_name, device, total_epochs, conf, model_conf, TrainerClass, resume, log_dir, seed=0):
    ### SETUP LOGGING ###
...
def get_trainer_class(dataset):
    trainer_dict = {
        "taobao": SimpleTrainerSupervised,
        "age": AccuracySimpleTrainerSupervised,
        "rosbank": SimpleTrainerSupervised,
        "physionet": SimpleTrainerSupervised,
    }
